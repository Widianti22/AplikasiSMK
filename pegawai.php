...
$siswa = query("SELECT * FROM pegawai");
...
<html lang="en">
  ...
  <body>
                    ...
                    <div class="modal-body text-primary">
                     <form>
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="mata_pelajaran" placeholder="Masukan Bagian">
                        </div>
                    </div>
          ...
          <table class="table table-striped table-bordered" >
            <thead>
               <tr>
                ...
                <th class="text-center" scope="col">Bagian</th>
      ...
      <th scope="row">1</th>
      <td>172072022</td>
      <td>Very supriadi.N</td>
      <td>L</td>
      <td>Bandung</td>
      <td>22 september 1987</td>
      <td>Operator</td>
       <td <a href=""class="btn btn-primary">Detail</a></td>
      <td><i class="fas fa-edit  mt-2 text-success rounded" data-toggle="tooltip" title="Edit"></i></td>
      <td><i class="fas fa-trash-alt  mt-2 p-6 text-danger rounded" data-toggle="tooltip" title="Delete"></i></td>
